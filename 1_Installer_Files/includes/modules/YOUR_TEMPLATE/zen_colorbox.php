...
if (ZEN_COLORBOX_STATUS == 'true') {
    ...
    $script_link = '<script type="text/javascript"><!--' . "\n" . 'document.write(\'' . ($flag_display_large ? '<a href="' . zen_colorbox($products_image_large, addslashes($products_name), LARGE_IMAGE_WIDTH, LARGE_IMAGE_HEIGHT) . '" rel="' . $rel . '" title="' . zen_output_string_protected($products_name) . '">' . $thumb_slashes . '<br \/>' . TEXT_CLICK_TO_ENLARGE . '<\/a>' : $thumb_slashes) . '\');' . "\n" . '//--></script>';
  } else {
