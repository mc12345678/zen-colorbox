...
DELETE FROM configuration WHERE configuration_group_id = @ZCBgID AND @ZCBgID != 0;

DELETE FROM admin_pages WHERE page_key = 'configZenColorbox';

DELETE FROM configuration_group WHERE configuration_group_id = @ZCBgID AND @ZCBgID != 0;
